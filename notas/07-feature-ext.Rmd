...
<!-- - La varianza se puede volver un problema grave. -->
<!-- - Esta técnica se usa para varios tipos de modelos. -->
<!-- - Es un paso que típicamente se hace (el proceso en la tarea de textos es un caso de feature engineering) -->
...
```
<!-- - Aquí estaríamos esperando ver una relación lineal entre la predicción y el valor real. -->
...
```
<!-- - Con estas modificaciones obtenemos un mejor desempeño del modelo. -->
...
ajuste_2 %>% pull_workflow_fit() %>% tidy %>%
  ...
  DT::datatable()
```
<!-- - En esta tabla estamos viendo que faltan los casos en los que no hay sótano. -->
<!-- - Estamos viendo que los que no son excelentes salen negativos, esto es problemático y hay que revisarlo bien. -->
