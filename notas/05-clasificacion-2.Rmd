...
<!-- - La regresión logística nos da como resultado probabilidades. -->
<!-- - Podemos hacer estas para hacer cálculos costo beneficio. -->
...
```
<!-- - Este es un ejemplo de como debríamos presentar nuestro análisis. No solo se reduce a "lo que dice el modelo". -->
<!-- - Hay que pegar el costo con la probabilidad para análisis costo beneficio. -->
...
<!-- - En análisis costo beneficio de arriba puede ser difícil de hacer en la vida real. -->
<!-- - Lo que podemos hacer es intentar evaluar las probabilidades más que las decisiones. -->
...
knitr::kable(tabla)
```
<!-- - Si sumas la columna "positivo" tienes todos los enfermos -->
<!-- - Si sumas el rengón tienes todo lo que dijo tu predicción -->
<!-- - Queremos una matriz con la mayoría de los casos en la diagonal -->
<!-- - Esta matriz de confusión puede ser un juego mental infernal. Hay varios puntos donde es muy confuso -->
<!--   - Puede ser que no tengas falsos positivos y tienes que confundirte pensando en que no es un falso negativo -->
...
<!-- - Qué tan especificamente reacciona la prueba -->
<!-- - Es como "descartar" -->
<!-- - En el caso de un buscador, puede no ser muy relevante porque tienes una infinidad de documentos no importantes, lo cual derivará en que te salga muy alto este valor. -->
<!-- - La especifidad puede ser muy importante en temas médicos. Puedes someter a las personas incorrectas a un tratamiento. -->
...
<!-- - Qué tan sensible es la prueba? -->
<!-- - Sería como hacer una búsqueda y ver qué tantas cosas buenas te regreso en comparación con todos los resultados -->
<!--   - No sirve de mucho que te de todos los docs buenos en medio de mucha basura (buena sensibilidad pero mala precisión) -->
...
<!-- - Este caso puede ser relevante para casos de campañas de marketing. -->
...
<!-- - Esta media armónica puede ayudar a evitar los vicios del promedio tradicional. -->
...
<!-- - Lo bueno de esta curva es que nos puede dar un indicador del costo de dar tratamiento a un tipo de personas en particular. -->
...
<!-- - La manera más fácil de hacero es entrenar un modelo de regresión logística para cada clase. -->
  <!-- - El chiste es sacar una probabilidad para cada modelo y comparar. -->
...
<!-- - La transformación softmax es ir de las "L's" a las probabilidades -->
...
- El que un modelo esté sobre parametrizado quiere decir 
