...
<!-- - Quieres ver como cambia la probabilidad según ciertos datos.  -->
<!-- - Queremos estimar las probabilidades -->
...
graf_2
```
<!-- - Para hacer una estimación de la probabilidad, podríamos definir un rango de los vecinos más cercanos. Cuentas los puntos rojos en esa vecindad, los verdes y después estimas la probabilidad de que caiga en uno u otro bucket. -->
<!-- - Hay que tener cuidado con colapsar la informacón, porque una persona con una probabilidad mucho más alta puede ser clasificada igual que una persona que no tenga tan buena probabilidad. -->
...
<!-- - El error se cuantifica dependiendo de lo que dices que obtiviste y lo que en realidad es. -->
<!-- - La función de error esta basada con -log -->
<!-- - Devianza se refiere al error. -->
<!-- - Para medir el error en un conjunto de datos sacamos la media de todos los datos. -->
<!-- - Las probabilidades de clase son mucho más importantes que solo la clasificación. -->
...
<!-- - La función sigmoidal es un gran ejemplo de una función que podría funcionar. -->
<!-- - Algunas funciones trigonométricas (tangente inversa) también podrían funcionar. -->
<!-- - La función de distribución acumulada de la normal funciona muy bien (integral de una campana normal). -->
...
$$h(x)=\frac{e^x}{1+e^x}$$
``` 
<!-- - Esta función, cuando se evalúa en x=0 es 0.5 -->
<!-- - Cuando se evalúa en infinito negativo la función tiende a 0. -->
<!-- - Cuando se evalúa en infinito positivo el resultado de la función tiende a 1. -->
<!-- - Aplicar esa "h" a la función significa evaluar el resultado de esta en la función logística (o la que se eliga para ajustar las probabilidades). -->
...
<!-- - Usamos "cuadrados" en regresión. Ahora vamos a usar devianza. -->
...
<!-- - Debemos minimizar moviendo los parámetros. -->
...
```
<!-- - Aquí observamos que según los resultados de la evaluación de nuestra variable, veremos para donde moveremos el parámetro. -->
...
<!-- - Esto de minimizar la devianza es lo mismo que maximizar la máxima verosimilitud.  -->
<!-- - Regresión logística es una buena aproximación. Su rigidez puede ser una ventaja. -->
...
diabetes_coef
```
<!-- - Aquí podríamos hacer cálculos afectando un solo parámetro y comparando sin afectar los parámetros. Esto nos daría como resultado un indicador de qué tanto afectaría de más como se afecto el parámetro mencionado. -->
...
<!-- - Si verificamos que el modelo está calibrado, podemos ya justificar las probabilidades. -->
