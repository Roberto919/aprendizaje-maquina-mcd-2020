...
<!-- - El método de regresión lineal puede ser más conveniente que modelos más complejos. -->
<!-- - Cuando tienes muchas variables de entrada puede ser bueno. -->
...
<!-- - Agarras grupos de puntos cercanos y sacas su promedio. -->
<!-- - El término "k" se refiere al número de vecinos que tomarás. -->
<!-- - Puedes pensar en hacer una estandarización de variables cuando estás en más de 1 dimensión -->
<!-- - ¿Podríamos usar este método para todos los problemas? En realidad no es cierto, hay métodos que superan facilmente este método. El argumento base tiene que ver con la maldición de la dimensionalidad. -->
<!-- - Un problema al que nos podemos enfrentar es tener que procesar todos los datos para poder hacer predicciones. -->
...
<!-- - En dimensiones altas el problema del sesgo y de la varianza que habíamos visto se exacerban. -->
<!-- - Para que un punto quede cerca del origen, muchos puntos deben quedar cerca del origen. Es una probabilidad muy baja de que en todas las dimensiones quede cerca de un punto de interés. -->
<!-- - Tener más dimensiones exige que tengas mucho más datos. -->
<!-- Los problemas de dimensión alta se vuelven inhóspitos y poco intuitivos. -->
...
<!-- - Lo que necesitamos es encontrar estructura útil para aprovechar el problema. Por ejemplo, un modelo lineal podría funcionar bien. -->
<!-- - Cuando estamos en problemas de imágenes se trata de un problema de dimensiones alta. Como tienen mucha estructura, las redes neuronales funcionan muy bien. Así podemos superar la maldición de la dimensionalidad. -->
<!-- - También la multidemsionalidad puede ser una bendición porque tienen mucha información para aprovechar. -->
...
<!-- - En problemas de mucha dimensión, los modelos lineales pueden ser más nobles. Supera al de vecinos cercanos. -->
<!-- - Si el supuesto de linealidad es adecuado, el modelo lineal puede funcionar muy bien. -->
<!-- - Con la regresión lineal aprovechamos todos los datos, mientras que con vecinos cercanos no aprovechamos todos los datos. -->
<!-- - La estructura y entendiendo los datos puedes construir modelos muy efectivos. -->
<!-- - Es muy difícil comprobar el supuesto de linealidad. Más bien tienes que probar el modelo lineal y ver que tal funciona. -->
