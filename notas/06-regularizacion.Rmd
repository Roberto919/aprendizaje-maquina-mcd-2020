...
los coeficientes.
  <!-- - En general no deberías correr modelos que se hicieron con menos datos que variables. En caso de que sí, tienes que aplicar la regularización. -->
...
valor en la media es igual a $h(\beta_0)$.
  <!-- - Normalmente lo pensarías cuando tienes muy pocos datos o cuando hay mucho ruido involucrado. -->
...
```
<!-- - La ventaja de esta penalización es que es muy barata. -->
...
<!-- - En realidad este es el caso para el cual se inventó la penalización Ridge. -->
<!-- - El problema con las variables correlacionadas es que no sabes a quien echarle la culpa. Puedes tener muchos modelos que den el mismo resultado. -->
...
<!-- - Las componentes principales son idea clave de este problema. -->
<!-- - Un ejercicio que se puede hacer es hacer una regresión en términos de x1 y x2. Después hacer una regresión Ridge. -->
<!--   - Notaremos que Ridge se encargará de repartir más parejo. -->
<!-- - Cuando hablamos de correlación siempre hablamos en términos lineales. Es qué tan fácil puedes establecer una relación lineal entre una variable y la otra. -->



### Selección de coeficiente de regularización
<!-- - Para seleccionar lambra no puedes usar el conjunto de entrenamiento, este ya te lo "gastaste" -->
...
flujo_reg <- workflow() %>% 
  ...
  add_recipe(receta)
```
<!-- - Por default te da una rejilla en escala logarítmica (log10_trans()) -->
...
desempeño
```
<!-- - Vamos a usar un nuevo conjunto de datos (validación). Los tres conjuntos que tendremos son: -->
...
```
<!-- - En general es buena idea penalizar para tener un modelo más robusto, con coeficientes más controlados. -->
<!--   - Podrías tener dos modelos muy parecidos pero nos interesa más el modelo que es más sencillo. El más "parsimonioso"/sencillo. -->
<!--   - Nos ayuda a que el modelo sea menos volatil. -->
...
```
<!-- - En validación es donde se ajustan los hiperparámetros. -->
<!-- - El conjunto de prueba se guarda en una caja fuerte. -->
<!-- - No debes hacer mucho ir y venir entre validación y entrenamiento. -->
<!-- - En entrenamiento ves muchas lambdas y en validación eliges el bueno. -->
<!-- - Debemos tener una forma de validar lo mejor posible nuestro modelo. -->
  <!-- - En entrenamiento es muy fácil obtener cosas buenas. En validación es lo importante. -->
  <!-- - Seleccionar la estructura correcta de los modelos. -->
    <!-- - Conocimiento del problema -->
    <!-- - Ajuste de los datos -->
  <!-- - Como afino los algoritmos para que funcionen al máximo. -->
    <!-- - Afianr el algoritmo es más algo computacional. -->
...
### Validación cruzada
<!-- - Requiere más cómputo pero nos puede ayudar a desgastar menos nuestro conjunto de validación. -->
<!-- - La idea es hacer conjuntos más pequeños derivados de los datos de entrenamiento. Haces como pequeños conjuntos de prueba y validación. -->
...
```
<!-- - Estas son divisiones del conjunto de entrenamiento. -->
<!--   - La parte azul son los datos de entrenamiento y la amarilla los de validación. -->
<!--   - El problema es que el error de cada "renglón" es que te dará un error con alta varianza. -->
<!--   - Lo que hacemos es sacar el promedio de los errores. -->
<!--     - El promedio nos dará un quinto de la varianza de todos los ejercicios. -->
<!-- - Ya que hicimos el ejercicio elegimos un modelo e hiper parámetros que mejor nos funcionaron. -->
<!-- - La de 5 y 10 particiones son las más pupulares -->
<!--   - El problema es que nuestro modelo con pocos datos de entrenamiento va a dar muy malas predicciones. -->
...
del mínimo.*
  <!-- - Te posicionas en el rango superior de punto con el menor error que esté regularizado y ahí te vas horizontalmente hasta el punto rojo. -->
...
<!-- - El error de validación cruzada no es el error de prueba. -->
...
```
<!-- - Aquí vemos que los errores no están correlacionados. -->
<!-- - Esto es en el caso de que la validación cruzada lo usemos para estimar el error de prueba. -->
<!-- - La validación cruzada no sustituye a una muestra de datos grandes. -->
...
<!-- - Aquí vemos que la regularización nos da casi un brinco gratuito en el desempeño. -->



## Regularización lasso
<!-- - No es muy diferente a Ridge -->
<!--   - Penaliza por el valor absoluto en lugar de por el cuadrado. -->
<!-- - La labmda la puedes pensar como un multiplicador de Lagrange. -->
